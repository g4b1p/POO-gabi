...
namespace evalucaion_2
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Operario operario1 = new Operario("raul", 23, 5400.5, "mañana");
            Operario operario2 = new Operario("jose", 21, 5400.5, "tarde");
            Operario operario3 = new Operario("juli", 40, 5400.5, "noche");
            Operario operario4 = new Operario("mica", 25, 5400.5, "tarde");
            ...
            Console.WriteLine();
            Console.WriteLine("los operarios mayores de 30 años: ");
            for (int i = opererios.Count - 1; i >= 0; i--)
            {
                if (opererios[i].Edad < 30)
                {
                    opererios.RemoveAt(i);
                }
            }
            foreach (var operario in opererios)
            {
            ...
            double sumSalarios = gerente.Salario;
            foreach (var o in opererios)
            {
                sumSalarios += o.Salario;
            }
            double promedioSalarios = sumSalarios / opererios.Count + 1; // 1 para el gerente
            Console.WriteLine("el promedio de salarios de los empleados: " + promedioSalarios);
